...
const Adhara = () => {
  ...
  return (
    <div className="">
      <div className="cards wrap adhara">
        <div className="title">Adhara Star</div>
        <a href="./documents/Adhara.pdf" className="card__link" target={'_blank'}>
          ...
          <Swiper
            ...
            <SwiperSlide>
              <div className="card">
                ...
                <Link to='/slider6'>
                <img src="./img/cards/adhara1.jpg" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider6'>
                <img src="./img/cards/adhara2.jpg" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider6'>
                <img src="./img/cards/adhara3.jpg" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider6'>
                <img src="./img/cards/adhara4.jpg" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider6'>
                <img src="./img/cards/adhara5.jpg" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>

...
const Luma = () => {
  ...
  return (
    <div className="">
      <div className="cards wrap luma">
        <div className="title">Luma22</div>
        <a href="./documents/luma22.pdf" className="card__link" target={'_blank'}>
          ...
          <Swiper
            ...
            <SwiperSlide>
              <div className="card">
                ...
                <Link to='/slider5'>
                <img src="./img/luma/luma1.png" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider5'>
                <img src="./img/luma/luma2.png" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider5'>
                <img src="./img/luma/luma3.png" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider5'>
                <img src="./img/luma/luma4.png" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                <Link to='/slider5'>
                <img src="./img/luma/luma5.png" alt="" />
                </Link>
                </div>
              </div>
            </SwiperSlide>

...
const SafaOneSlider = () => {
  ...
  return (
    <div className="slider-safa-one">
      <div className="cards wrap safa-one-slider">
            ...
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                  <img src='./img/safa-one/main-slide.png' alt="" />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                  <img src='./img/safa-one/slide1.png' alt="" />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                  <img src='./img/safa-one/slide2.png' alt="" />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                  <img src='./img/safa-one/slide3.png' alt="" />
                </div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="card">
                <div className="card__image">
                  <img src='./img/safa-one/image4.png' alt="" />
                </div>
              </div>
            </SwiperSlide>
          </Swiper>
